    ...
    <div className="p-6 md:p-10 space-y-6 md:space-y-8 animate-in fade-in duration-500 max-w-5xl mx-auto h-full flex flex-col justify-center">
      ...
      >
        ...
        <h2 className="text-2xl md:text-3xl font-extrabold tracking-tight">
          {t('dashboardWorkoutTitle', 'Antrenman Takibi')}
        </h2>
        <p className="font-medium opacity-80 mt-2">
          {t('dashboardWorkoutDesc', 'Hareketlerini ve setlerini yönet')}
        </p>
      </div>

      <div className="grid grid-cols-2 gap-4 md:gap-8">
        
        {/* BESLENME VE SU KARTI */}
        <div 
        ...
        >
          ...
          <h2 className="text-sm md:text-xl font-bold tracking-wide">
            {t('dashboardNutrition', 'Beslenme')}<br/>& {t('dashboardWater', 'Su')}
          </h2>
        </div>
        ...
        >
          ...
          <h2 className="text-sm md:text-xl font-bold tracking-wide">
            {t('dashboardProgress', 'Gelişim')}<br/>{t('dashboardReport', 'Raporu')}
          </h2>
        </div>
      </div>
